...
if(isset($_GET['what'])) {
    if($_GET['what'] == 'members') {
        ...
        $csv_cols = ['member_id', 'first_name', 'last_name', 'email', 'phone_number', 'photo_path', 'training_plan_id', 'trainer_id', 'access_card_pdf_path', 'created_at'];
